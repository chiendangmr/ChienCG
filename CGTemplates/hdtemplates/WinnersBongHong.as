package  {
	...
	public class WinnersBongHong extends CasparTemplate{
		...
		public function WinnersBongHong() {
			// constructor code
			super();
		...
		private function comeIn():void{
			...
			this.singleTween = new Tween(myTotalBar, "x", Regular.easeOut, -1500, 213, 0.5, true);
		...
		private function comeOutBar(e:Event):void{
			this.singleTween = new Tween(myTotalBar, "y", Regular.easeOut, 432, 1200, 1, true);
		}
